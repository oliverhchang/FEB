...
# --- Input Data for Front Left Bottom A-Arm (AFT) ---
connection_node = {'x': -5.52, 'y': 7.39, 'z': -2.17}
a_arm_connection = {'x': 0.15, 'y': 22.16, 'z': -3.73}  # Lower Upright
all_tubes = [
    ("To fore lower a-arm", {'x': 6.11, 'y': 7.39, 'z': -2.17}),
    ("To aft upper a-arm", {'x': -3.87, 'y': 9.85, 'z': 6.45}),
    ("To bottom SIS", {'x': -22.65, 'y': 12.34, 'z': -5.50}),
    ("To right side", {'x': -5.52, 'y': -7.32, 'z': -2.17})
]

# Applied Forces from table
peak_compression_force = -3117.053145
peak_tension_force = 773.3014167

# --- Run Full Analysis ---
print("--- Analysis for Front Left Bottom A-Arm (AFT) ---")
