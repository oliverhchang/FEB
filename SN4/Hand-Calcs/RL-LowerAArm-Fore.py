...
# --- Input Data for Rear Left Bottom A-Arm (FRONT) ---
connection_node = {'x': -52.18, 'y': 11.20, 'z': -4.63}
a_arm_connection = {'x': -62.59, 'y': 22.16, 'z': -3.73}  # Lower Upright
all_tubes = [
    ("Lower accum protection", {'x': -22.65, 'y': 12.34, 'z': -5.50}),
    ("Laterally Across", {'x': -52.18, 'y': -11.20, 'z': -4.63}),
    ("Vertically to upper a-arm fore", {'x': -52.03, 'y': 9.87, 'z': 5.24}),
    ("Diagonally to upper a-arm aft", {'x': -62.11, 'y': 10.11, 'z': 3.67}),
    ("Horizontally to lower a-arm", {'x': -5.52, 'y': 7.39, 'z': -2.17})
]

# Applied Forces from table
peak_compression_force = -5124.975411
peak_tension_force = 4518.63763

# --- Run Full Analysis ---
print("--- Analysis for Rear Left Bottom A-Arm (FRONT) ---")
