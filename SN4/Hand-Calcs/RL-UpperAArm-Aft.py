...
# --- Input Data for Rear Left Upper A-Arm (REAR) ---
connection_node = {'x': -62.11, 'y': 10.11, 'z': 3.67}
a_arm_connection = {'x': -62.81, 'y': 21.68, 'z': 3.73}  # Upper Upright
all_tubes = [
    ("Laterally across", {'x': -62.11, 'y': -10.11, 'z': 3.67}),
    ("To fore upper a-arm node", {'x': -52.03, 'y': 9.87, 'z': 5.24}),
    ("To bottom aft lower a-arm node", {'x': -61.76, 'y': 10.30, 'z': -4.35}),
    ("Diagonal to fore lower a-arm node", {'x': -52.18, 'y': 11.20, 'z': -4.63})
]

# Applied Forces from table
peak_compression_force = -95.65652814
peak_tension_force = 3728.387895

# --- Run Full Analysis ---
print("--- Analysis for Rear Left Upper A-Arm (REAR) ---")
