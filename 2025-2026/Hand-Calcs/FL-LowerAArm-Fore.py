...
# --- Input Data for Front Left Bottom A-Arm (FORE) ---
connection_node = {'x': 6.11, 'y': 7.39, 'z': -2.17}
a_arm_connection = {'x': 0.15, 'y': 22.16, 'z': -3.73}  # Lower Upright
all_tubes = [
    ("To Front bulkhead bottom", {'x': 25.80, 'y': 7.39, 'z': -2.17}),
    ("To upper fore a-arm", {'x': 3.88, 'y': 9.21, 'z': 4.20}),
    ("To lower aft a-arm", {'x': -5.52, 'y': 7.39, 'z': -2.17}),
    ("To right side", {'x': 6.11, 'y': -7.39, 'z': -2.17})
]
...
# --- Run Full Analysis ---
print("--- Analysis for Front Left Bottom A-Arm (FORE) ---")
